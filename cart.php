...
<section class="py-5">
    <div class="container">
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Price:</b> <span class="price"><?php echo format_num($row['price']) ?></span></small></p>
                                <div>
        ...
        <div class="d-flex w-100 justify-content-end">
            <a href="./?p=checkout" class="btn bg-gradient-pink btn-sm ">Checkout</a>
        </div>
    </div>
</section>
<script>
